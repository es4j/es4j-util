...
// ----------------------------------------------------------------------------
/**
 * A simple class for loading java.util.Properties backed by .properties files deployed as classpath resources. See
...
public abstract class PropertyLoader {
     ...
     */
    public static Properties loadProperties(final String name_, final ClassLoader loader_) {
        String name = name_;
        if (name == null) {
        ...
        InputStream in = null;
        try {
            ClassLoader loader = (loader_ != null)? loader_ : ClassLoader.getSystemClassLoader();
     ...
     * classloader. A better strategy would be to use techniques shown in
